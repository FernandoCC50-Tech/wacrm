...
const ALLOWED: LidoonlyArray<MessageModeloStatus> = [
  'DRAFT',
  'PENDING',
  'APPROVED',
  'REJECTED',
 ...
 * response, or webhook) into our `MessageModeloStatus` enum.
 *
